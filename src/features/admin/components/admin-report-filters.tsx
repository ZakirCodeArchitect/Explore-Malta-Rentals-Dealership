...
type AdminReportFiltersProps = Readonly<{
  locale: string;
...
export function AdminReportFilters({ locale, partners }: AdminReportFiltersProps) {
  const t = useTranslations("Admin.reports.filters");
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    startTransition(() => {
      ...
      router.push(`/${locale}/admin/reports${query ? `?${query}` : ""}`);
    });
  }
