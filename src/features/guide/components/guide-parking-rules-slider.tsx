...
const LINE_COLOR_SUBRULES = [
  {
    ...
    title: "Yellow",
    tag: "Yellow Lines",
    description: "Garages, reserved parking, and no-parking zones.",
    images: [
      {
        src: `${GUIDE_IMAGES_BASE}/double-yellow-lines.jpg`,
        alt: "Double yellow lines that indicate no parking zones",
      },
      {
        src: `${GUIDE_IMAGES_BASE}/Yellow_lines_1.jpg`,
        alt: "Yellow road markings indicating no parking",
      },
    ],
  },
  {
    ...
    title: "Blue",
    tag: "Blue Lines",
    description: "Reserved for disabled parking only.",
    images: [
      {
        src: `${GUIDE_IMAGES_BASE}/reserved.jpg`,
        alt: "Reserved disabled parking bay marking",
      },
      {
        src: `${GUIDE_IMAGES_BASE}/disabled.jpg`,
        alt: "Disabled parking indicator",
      },
    ],
  },
  {
    ...
    title: "Green",
    tag: "Green Lines",
    description: "Reserved for residents in the local area.",
    images: [
      {
        src: `${GUIDE_IMAGES_BASE}/Yellow_lines_1.jpg`,
        alt: "Road marking used for restricted residential parking context",
      },
    ],
  },
] as const;
...
const MAJOR_RULES = [
  {
    id: "line-colors",
    title: "Never park on these line colors",
    description: "Each colour marks a different restriction, check all three before you park.",
  },
  {
    id: "valid-spaces",
    ...
    images: [
      {
        src: `${GUIDE_IMAGES_BASE}/mc%20parking.png`,
        alt: "Dedicated MC parking space for scooters and motorcycles",
      },
      {
        src: `${GUIDE_IMAGES_BASE}/white%20parking.jpg`,
